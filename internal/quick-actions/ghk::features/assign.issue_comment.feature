Feature: assign someone with /assign @user [@user...] on issue comment event
  ...
  Scenario: /assign @mojombo
    ...
    Then Github Quick Actions should handle command "/assign" for "issue_comment" event with arguments ["@mojombo"] by sending these following requests
      ...
      | POST               | https://api.github.com/repos/xunleii/github-quick-actions/issues/0/assignees | {"assignees":["mojombo"]} |
  ...
  Scenario: /assign @mojombo @defunkt
    ...
    Then Github Quick Actions should handle command "/assign" for "issue_comment" event with arguments ["@mojombo","@defunkt"] by sending these following requests
      | API request method | API request URL                                                              | API request payload                  |
      | POST               | https://api.github.com/repos/xunleii/github-quick-actions/issues/0/assignees | {"assignees":["mojombo", "defunkt"]} |
  ...
  Scenario: /assign me
    ...
    Then Github Quick Actions should handle command "/assign" for "issue_comment" event with arguments ["me"] by sending these following requests
      | API request method | API request URL                                                              | API request payload       |
      | POST               | https://api.github.com/repos/xunleii/github-quick-actions/issues/0/assignees | {"assignees":["xunleii"]} |
  ...
  Scenario: /assign @mojombo me
    ...
    Then Github Quick Actions should handle command "/assign" for "issue_comment" event with arguments ["@mojombo","me"] by sending these following requests
      | API request method | API request URL                                                              | API request payload                  |
      | POST               | https://api.github.com/repos/xunleii/github-quick-actions/issues/0/assignees | {"assignees":["mojombo", "xunleii"]} |
  ...
  Scenario: /assign me on an invalid repository
    Given Github replies to 'POST https://api.github.com/repos/xunleii/github-quick-actions/issues/0/assignees' with '404 {"message": "Not Found", "documentation_url": "https://docs.github.com/en/rest/reference/issues#add-labels-to-an-issue"}'
    When Github sends an event "issue_comment" with
      """
      {
        "action": "created",
      ...
      """
    Then Github Quick Actions should handle command "/assign" for "issue_comment" event with arguments ["me"] but returns this error: 'POST https://api.github.com/repos/xunleii/github-quick-actions/issues/0/assignees: 404 Not Found []'
