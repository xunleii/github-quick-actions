@issue_comment
Feature: remove label with /unlabel ~label [~label...] on issue comment
  ...
  Scenario: error handling on /unlabel
    ...
    When Github sends an event "issue_comment" with
      ...
      """
    Then Github Quick Actions should handle command "/unlabel" for "issue_comment" event with arguments ["~feature"] but returns this error: 'DELETE https://api.github.com/repos/xunleii/github-quick-actions/issues/1/labels/feature: 404 Not Found []'
